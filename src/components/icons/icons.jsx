...
export const CashIcon = ({ className, onClick })  => (
...
export const HotlineIcon = ({ className, onClick })  => (
...
export const MapMarkerIcon = ({ className, onClick })  => (
  <img src={iconMapMarker} className={className} onClick={onClick} alt="" />
)
export const MomoIcon = ({ className, onClick })  => (
  <img src={iconMomo} className={className} onClick={onClick} alt="" />
)
export const PinterestIcon = ({ className, onClick })  => (
...
export const VisaIcon = ({ className, onClick })  => (
...
export const ZaloIcon = ({ className, onClick })  => (
  <img src={iconZalo} className={className} onClick={onClick} alt="" />
)
export const ZalopayIcon = ({ className, onClick })  => (
